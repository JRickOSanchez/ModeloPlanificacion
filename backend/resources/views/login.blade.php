                            ...
                            <div class="accordion-content-wrapper">
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="exampleFormControlInput1" autocomplete="false"
                                               placeholder="correo@potros.itson.edu.mx">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleFormControlInput2">Contraseña</label>
                                        <input type="password" placeholder="***********" class="form-control" autocomplete="false"
